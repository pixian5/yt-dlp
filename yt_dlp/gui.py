...
TRANSLATIONS = {
    ...
    'ru': {
        'Write thumbnail image (--write-thumbnail)': 'Записать миниатюру изображения (--write-thumbnail)',
        'List available thumbnails (--list-thumbnails)': 'Вывести список доступных миниатюр (--list-thumbnails)',
        'Username:': 'Имя пользователя:',
        'Password:': 'Пароль:',
        'Extract audio (--extract-audio)': 'Извлечь аудио (--extract-audio)',
        'Audio format:': 'Аудио формат:',
        'Quiet mode (-q, --quiet)': 'Тихий режим (-q, --quiet)',
        'Verbose output (-v, --verbose)': 'Подробный вывод (-v, --verbose)',
        ...
        'Exclude private videos': 'Исключить частные видео',
        'Reverse order': 'Обратный порядок',
        'Clipboard is empty.': 'Буфер обмена пуст.',
        'Pasted link from clipboard.': 'Вставил ссылку из буфера обмена.',
        ...
        'Flat playlist extraction:': 'Извлечение плоского плейлиста:',
        'Age limit (years):': 'Возрастное ограничение (лет):',
        'Download archive file:': 'Скачать архивный файл:',
        'Max downloads:': 'Максимальное количество загрузок:',
        'Proxy URL:': 'URL-адрес прокси:',
        'Socket timeout (seconds):': 'Тайм-аут сокета (секунды):',
        'Source address (bind to):': 'Адрес источника (привязка к):',
        'Sleep interval (seconds):': 'Интервал сна (секунды):',
        'Max sleep interval (seconds):': 'Максимальный интервал сна (секунды):',
        'Sleep interval for requests (seconds):': 'Интервал ожидания для запросов (секунды):',
        'Sleep interval for subtitles (seconds):': 'Интервал сна для субтитров (секунды):',
        'Rate limit (e.g., "50K" or "4.2M"):': 'Ограничение скорости (например, «50 тыс.» или «4,2 млн»):',
        'Throttled rate (minimum rate):': 'Дросселированная скорость (минимальная скорость):',
        'Retries:': 'Повторные попытки:',
        'Fragment retries:': 'Повторные попытки фрагмента:',
        'Geo verification proxy:': 'Прокси-сервер геопроверки:',
        'Geo bypass country:': 'Страна обхода географического региона:',
        'Geo bypass IP block:': 'Геообход IP-блокировки:',
        'Playlist items:': 'Элементы плейлиста:',
        'Playlist start:': 'Начало плейлиста:',
        'Playlist end:': 'Конец плейлиста:',
        'Match title (regex):': 'Название матча (регулярное выражение):',
        'Reject title (regex):': 'Отклонить заголовок (регулярное выражение):',
        'Min filesize (e.g., 50k or 1M):': 'Минимальный размер файла (например, 50\xa0КБ или 1\xa0М):',
        'Max filesize (e.g., 50M or 1G):': 'Максимальный размер файла (например, 50 МБ или 1 ГБ):',
        'Date (YYYYMMDD):': 'Дата (ГГГГММДД):',
        'Date before (YYYYMMDD):': 'Дата до (ГГГГММДД):',
        'Date after (YYYYMMDD):': 'Дата после (ГГГГММДД):',
        'Min views:': 'Минимальное количество просмотров:',
        'Max views:': 'Максимальное количество просмотров:',
        ...
        'HTTP chunk size:': 'Размер HTTP-блока:',
        'External downloader:': 'Внешний загрузчик:',
        'External downloader args:': 'Аргументы внешнего загрузчика:',
        'Output template:': 'Выходной шаблон:',
        'Output directory:': 'Выходной каталог:',
        'Paths configuration:': 'Конфигурация путей:',
        'Load info JSON:': 'Загрузить информацию JSON:',
        'Cache directory:': 'Каталог кэша:',
        'Format selection:': 'Выбор формата:',
        'Format sort:': 'Сортировка формата:',
        'Merge output format:': 'Формат вывода слияния:',
        'Video multistreams:': 'Мультипотоки видео:',
        'Audio multistreams:': 'Мультипотоки аудио:',
        ...
        'Adobe Pass MSO:': 'Adobe Pass MSO：',
        'Adobe Pass username:': 'Имя пользователя Adobe Pass:',
        ...
        'Client certificate password:': 'Пароль сертификата клиента:',
        'Audio quality:': 'Качество звука:',
        'Recode video format:': 'Перекодировать формат видео:',
        'Remux video format:': 'Формат видео ремукса:',
        'Metadata fields:': 'Поля метаданных:',
        'Parse metadata:': 'Разобрать метаданные:',
        'FFmpeg location:': 'Расположение FFmpeg:',
        'Post-processor args:': 'Аргументы постпроцессора:',
        'Convert thumbnails format:': 'Конвертировать формат миниатюр:',
        ...
        'Sleep before requests:': 'Спать перед запросами:',
        'SponsorBlock categories to remove:': 'Категории SponsorBlock, которые нужно удалить:',
        'SponsorBlock categories to mark:': 'Категории SponsorBlock для отметки:',
        'SponsorBlock chapter title:': 'Название главы SponsorBlock:',
        'SponsorBlock API URL:': 'URL API SponsorBlock:',
        'Extractor arguments:': 'Аргументы экстрактора:',
        'Extractor retries:': 'Повторные попытки экстрактора:',
        'Cookies from browser:': 'Файлы cookie из браузера:',
        'Cookies file:': 'Файл cookie:',
        'Raw command-line arguments:': 'Необработанные аргументы командной строки:',
        'ERROR: yt-dlp not found. Please make sure yt-dlp is installed and in your PATH.': 'ОШИБКА: yt-dlp не найден. Убедитесь, что yt-dlp установлен и указан в вашем PATH.',
        'ERROR: ': 'ОШИБКА:',
        '(e.g., "ytsearch5:")': '(например, «ytsearch5:»)',
        '(ISO 3166-2 code)': '(код ISO 3166-2)',
        '(CIDR notation)': '(нотация CIDR)',
        '(e.g., "1-5,10,15-20")': '(например, «1-5,10,15-20»)',
        '(e.g., 50K or 4.2M)': '(например, 50 тыс. или 4,2 млн.)',
        '(e.g., "%(title)s.%(ext)s")': '(например, «%(title)s.%(ext)s»)',
        '(e.g., "bestvideo+bestaudio")': '(например, «лучшее видео+лучшее аудио»)',
        '(comma-separated, e.g., "en,fr,de")': '(через запятую, например, «en,fr,de»)',
        '(comma-separated)': '(через запятую)',
        '(key:val[,val] format)': '(формат ключа:val[,val])',
        '(One argument per line or space-separated)': '(Один аргумент в строке или через пробел)',
        '(0-10, 0 = best)': '(0-10, 0 = лучший)',
        'Ignore errors (--ignore-errors)': 'Игнорировать ошибки (--ignore-errors)',
        'Ignore warnings (--no-warnings)': 'Игнорировать предупреждения (--no-warnings)',
        'Abort on error (--abort-on-error)': 'Прервать работу при ошибке (--abort-on-error)',
        'Download only video, not playlist (--no-playlist)': 'Загружать только видео, а не плейлист (--no-playlist)',
        'Download playlist (--yes-playlist)': 'Скачать плейлист (--yes-playlist)',
        'Include private/unavailable videos in YouTube playlists': 'Включайте частные/недоступные видео в плейлисты YouTube.',
        'Mark videos as watched (--mark-watched)': 'Отметить видео как просмотренные (--mark-watched)',
        'Do not mark videos as watched (--no-mark-watched)': 'Не отмечать видео как просмотренные (--no-mark-watched)',
        'Force IPv4 (--force-ipv4)': 'Принудительно использовать IPv4 (--force-ipv4)',
        'Force IPv6 (--force-ipv6)': 'Принудительно использовать IPv6 (--force-ipv6)',
        'Enable file:// URLs (--enable-file-urls)': 'Включить URL-адреса file:// (--enable-file-urls)',
        'Bypass geo restriction (--geo-bypass)': 'Обход географических ограничений (--geo-bypass)',
        'Do not bypass geo restriction (--no-geo-bypass)': 'Не обходить географические ограничения (--no-geo-bypass)',
        'Break on existing (--break-on-existing)': 'Разрыв существующего (--break-on-existing)',
        'Break on reject (--break-on-reject)': 'Разрыв при отклонении (--break-on-reject)',
        'No break on existing (--no-break-on-existing)': 'Нет разрыва существующих (--no-break-on-existing)',
        'Do not resize buffer (--no-resize-buffer)': 'Не изменять размер буфера (--no-resize-buffer)',
        'Test mode - do not download (--test)': 'Тестовый режим - не скачивать (--test)',
        'Prefer native HLS downloader (--hls-prefer-native)': 'Предпочитаю собственный загрузчик HLS (--hls-prefer-native)',
        'Prefer ffmpeg for HLS (--hls-prefer-ffmpeg)': 'Предпочитать ffmpeg для HLS (--hls-prefer-ffmpeg)',
        'Use MPEG-TS container for HLS (--hls-use-mpegts)': 'Использовать контейнер MPEG-TS для HLS (--hls-use-mpegts)',
        'Restrict filenames to ASCII (--restrict-filenames)': 'Ограничить имена файлов ASCII (--restrict-filenames)',
        'Allow Unicode in filenames (--no-restrict-filenames)': 'Разрешить использование Юникода в именах файлов (--no-restrict-filenames)',
        'Create playlist subfolder for playlist downloads': 'Создайте подпапку плейлиста для загрузки плейлистов.',
        'Force Windows-compatible filenames (--windows-filenames)': 'Принудительно использовать имена файлов, совместимые с Windows (--windows-filenames)',
        'Do not overwrite files (--no-overwrites)': 'Не перезаписывать файлы (--no-overwrites)',
        'Force overwrite files (--force-overwrites)': 'Принудительно перезаписать файлы (--force-overwrites)',
        'Continue partially downloaded files (--continue)': 'Продолжить частично загруженные файлы (--continue)',
        'Do not continue downloads (--no-continue)': 'Не продолжать загрузку (--no-continue)',
        'Do not use .part files (--no-part)': 'Не используйте файлы .part (--no-part)',
        'Do not use Last-modified header (--no-mtime)': 'Не используйте заголовок Last-modified (--no-mtime)',
        'Write description to .description file (--write-description)': 'Записать описание в файл .description (--write-description)',
        'Write metadata to .info.json file (--write-info-json)': 'Записать метаданные в файл .info.json (--write-info-json)',
        'Write annotations to .annotations.xml (--write-annotations)': 'Запись аннотаций в .annotations.xml (--write-annotations)',
        'Write comments to .comments.json (--write-comments)': 'Напишите комментарии в .comments.json (--write-comments)',
        'Disable filesystem caching (--no-cache-dir)': 'Отключить кэширование файловой системы (--no-cache-dir)',
        'Delete cache directory contents (--rm-cache-dir)': 'Удалить содержимое каталога кэша (--rm-cache-dir)',
        'Prefer free formats (--prefer-free-formats)': 'Предпочитаете свободные форматы (--prefer-free-formats)',
        'Check available formats (--check-formats)': 'Проверить доступные форматы (--check-formats)',
        'Write subtitle file (--write-subs)': 'Записать файл субтитров (--write-subs)',
        'Write automatic subtitle file (--write-auto-subs)': 'Записать автоматический файл субтитров (--write-auto-subs)',
        'List available subtitles (--list-subs)': 'Список доступных субтитров (--list-subs)',
        'Embed subtitles (--embed-subs)': 'Встроить субтитры (--embed-subs)',
        'Do not embed subtitles (--no-embed-subs)': 'Не вставлять субтитры (--no-embed-subs)',
        'Embed thumbnail (--embed-thumbnail)': 'Вставить миниатюру (--embed-thumbnail)',
        'Do not embed thumbnail (--no-embed-thumbnail)': 'Не вставлять миниатюру (--no-embed-thumbnail)',
        'Use .netrc authentication (--netrc)': 'Использовать аутентификацию .netrc (--netrc)',
        'Extract audio (-x, --extract-audio)': 'Извлечь аудио (-x, --extract-audio)',
        'Keep video file after conversion (--keep-video)': 'Сохранять видеофайл после конвертации (--keep-video)',
        'Do not keep video file (--no-keep-video)': 'Не сохранять видеофайл (--no-keep-video)',
        'Embed metadata (--embed-metadata)': 'Встроить метаданные (--embed-metadata)',
        'Embed chapter markers (--embed-chapters)': 'Встроить маркеры глав (--embed-chapters)',
        'Embed info.json (--embed-info-json)': 'Встроить info.json (--embed-info-json)',
        'Add metadata to file (--add-metadata)': 'Добавить метаданные в файл (--add-metadata)',
        'Write all thumbnail formats (--write-all-thumbnails)': 'Записать все форматы миниатюр (--write-all-thumbnails)',
        'No warnings (--no-warnings)': 'Никаких предупреждений (--no-warnings)',
        'Simulate, do not download (-s, --simulate)': 'Имитировать, не загружать (-s, --simulate)',
        'Skip download (--skip-download)': 'Пропустить загрузку (--skip-download)',
        'Get title (--get-title)': 'Получить заголовок (--get-title)',
        'Get ID (--get-id)': 'Получить идентификатор (--get-id)',
        'Get URL (--get-url)': 'Получить URL-адрес (--get-url)',
        'Get thumbnail URL (--get-thumbnail)': 'Получить URL миниатюры (--get-thumbnail)',
        'Get description (--get-description)': 'Получить описание (--get-description)',
        'Get duration (--get-duration)': 'Получить продолжительность (--get-duration)',
        'Get filename (--get-filename)': 'Получить имя файла (--get-filename)',
        'Get format (--get-format)': 'Получить формат (--get-format)',
        'Dump JSON info (--dump-json)': 'Дамп информации JSON (--dump-json)',
        'Dump single JSON (--dump-single-json)': 'Дамп одного JSON (--dump-single-json)',
        'Print JSON info (--print-json)': 'Распечатать информацию JSON (--print-json)',
        'Show progress (--progress)': 'Показать прогресс (--progress)',
        'Hide progress (--no-progress)': 'Скрыть прогресс (--no-progress)',
        'Display progress in console title (--console-title)': 'Отображать прогресс в заголовке консоли (--console-title)',
        'Skip SSL certificate validation (--no-check-certificate)': 'Пропустить проверку SSL-сертификата (--no-check-certificate)',
        'Prefer insecure connections (--prefer-insecure)': 'Предпочитать небезопасные соединения (--prefer-insecure)',
        'Bidirectional text workaround (--bidi-workaround)': 'Обходной путь двунаправленного текста (--bidi-workaround)',
        'Use legacy server connect (--legacy-server-connect)': 'Использовать подключение к устаревшему серверу (--legacy-server-connect)',
        'Mark SponsorBlock chapters (--sponsorblock-mark)': 'Отметить главы SponsorBlock (--sponsorblock-mark)',
        'Remove SponsorBlock segments (--sponsorblock-remove)': 'Удалить сегменты SponsorBlock (--sponsorblock-remove)',
        'Disable SponsorBlock (--no-sponsorblock)': 'Отключить SponsorBlock (--no-sponsorblock)',
        'Allow dynamic MPD manifests (--allow-dynamic-mpd)': 'Разрешить динамические манифесты MPD (--allow-dynamic-mpd)',
        'Ignore dynamic MPD manifests (--ignore-dynamic-mpd)': 'Игнорировать динамические манифесты MPD (--ignore-dynamic-mpd)',
        'Split HLS segments on discontinuity (--hls-split-discontinuity)': 'Разделить сегменты HLS при разрыве (--hls-split-discontinuity)',
    },
    'ja': {
        ...
        'Paste Link:': 'リンクを貼り付けます:',
        'Stop': '停止',
        'Download stopped. Would you like to delete partially downloaded files?': 'ダウンロードが停止されました。部分的にダウンロードしたファイルを削除しますか?',
        'Parse Playlist': 'プレイリストを解析する',
        'Exclude private videos': 'プライベートビデオを除外する',
        'Reverse order': '逆順',
        ...
        'Default search prefix:': 'デフォルトの検索プレフィックス:',
        'Flat playlist extraction:': 'フラットプレイリスト抽出:',
        'Age limit (years):': '年齢制限 (歳):',
        'Download archive file:': 'アーカイブ ファイルをダウンロードします:',
        'Max downloads:': '最大ダウンロード数:',
        'Proxy URL:': 'プロキシ URL:',
        'Socket timeout (seconds):': 'ソケットのタイムアウト (秒):',
        'Source address (bind to):': '送信元アドレス (バインド先):',
        'Sleep interval (seconds):': 'スリープ間隔 (秒):',
        'Max sleep interval (seconds):': '最大スリープ間隔 (秒):',
        'Sleep interval for requests (seconds):': 'リクエストのスリープ間隔 (秒):',
        'Sleep interval for subtitles (seconds):': '字幕のスリープ間隔 (秒):',
        'Rate limit (e.g., "50K" or "4.2M"):': 'レート制限 (例: 「50K」または「4.2M」):',
        'Throttled rate (minimum rate):': 'スロットルレート (最小レート):',
        'Retries:': '再試行:',
        'Fragment retries:': 'フラグメントの再試行:',
        'Geo verification proxy:': '地理的検証プロキシ:',
        'Geo bypass country:': '地域バイパス国:',
        'Geo bypass IP block:': '地域バイパス IP ブロック:',
        'Playlist items:': 'プレイリスト項目:',
        'Playlist start:': 'プレイリストの開始:',
        'Playlist end:': 'プレイリストの終わり:',
        'Match title (regex):': '一致タイトル (正規表現):',
        'Reject title (regex):': 'タイトルを拒否する (正規表現):',
        'Min filesize (e.g., 50k or 1M):': '最小ファイルサイズ (例: 50k または 1M):',
        'Max filesize (e.g., 50M or 1G):': '最大ファイルサイズ (例: 50M または 1G):',
        'Date (YYYYMMDD):': '日付 (YYYYMMDD):',
        'Date before (YYYYMMDD):': '前の日付 (YYYYMMDD):',
        'Date after (YYYYMMDD):': '以降の日付 (YYYYMMDD):',
        'Min views:': '最小ビュー:',
        'Max views:': '最大ビュー数:',
        'Match filter:': '一致フィルター:',
        'Concurrent fragments:': '同時フラグメント:',
        'Limit download rate:': 'ダウンロード速度の制限:',
        'Buffer size:': 'バッファサイズ:',
        'HTTP chunk size:': 'HTTP チャンク サイズ:',
        'External downloader:': '外部ダウンローダー:',
        'External downloader args:': '外部ダウンローダーの引数:',
        'Output template:': '出力テンプレート:',
        'Output directory:': '出力ディレクトリ:',
        'Paths configuration:': 'パスの構成:',
        'Load info JSON:': '情報 JSON を読み込みます:',
        'Cache directory:': 'キャッシュディレクトリ:',
        'Format selection:': 'フォーマットの選択:',
        'Format sort:': 'フォーマットソート:',
        'Merge output format:': 'マージ出力形式:',
        'Video multistreams:': 'ビデオマルチストリーム:',
        'Audio multistreams:': 'オーディオマルチストリーム:',
        'Subtitle format:': '字幕形式:',
        'Subtitle languages:': '字幕言語:',
        'Two-factor code:': '2 要素コード:',
        'Video password:': 'ビデオパスワード:',
        'Adobe Pass MSO:': 'Adobe Pass MSO：',
        'Adobe Pass username:': 'Adobe Pass ユーザー名:',
        'Adobe Pass password:': 'Adobe パスのパスワード:',
        'Client certificate:': 'クライアント証明書:',
        'Client certificate key:': 'クライアント証明書キー:',
        'Client certificate password:': 'クライアント証明書のパスワード:',
        'Audio quality:': 'オーディオ品質:',
        'Recode video format:': 'ビデオ形式を再コード:',
        'Remux video format:': 'リマックスビデオ形式:',
        'Metadata fields:': 'メタデータフィールド:',
        'Parse metadata:': 'メタデータを解析します。',
        'FFmpeg location:': 'FFmpeg の場所:',
        'Post-processor args:': 'ポストプロセッサ引数:',
        'Convert thumbnails format:': 'サムネイル形式を変換します。',
        ...
        'Referer:': 'リファラー:',
        'Add header:': 'ヘッダーを追加します。',
        'Sleep before requests:': 'リクエストの前にスリープします:',
        'SponsorBlock categories to remove:': '削除する SponsorBlock カテゴリ:',
        'SponsorBlock categories to mark:': 'マークするスポンサーブロック カテゴリ:',
        'SponsorBlock chapter title:': 'スポンサーブロックの章タイトル:',
        'SponsorBlock API URL:': 'スポンサーブロック API URL:',
        'Extractor arguments:': 'エクストラクターの引数:',
        'Extractor retries:': 'エクストラクターが再試行します:',
        'Cookies from browser:': 'ブラウザからの Cookie:',
        'Cookies file:': 'クッキーファイル:',
        'Raw command-line arguments:': '生のコマンドライン引数:',
        'ERROR: yt-dlp not found. Please make sure yt-dlp is installed and in your PATH.': 'エラー: yt-dlp が見つかりません。 yt-dlp がインストールされており、PATH にあることを確認してください。',
        'ERROR: ': 'エラー：',
        'Load Configuration': '設定をロードする',
        'Save Configuration': '設定の保存',
        'Select Batch File': 'バッチファイルの選択',
        'Select Config File': '構成ファイルの選択',
        'Select Archive File': 'アーカイブファイルの選択',
        'Select Output Directory': '出力ディレクトリの選択',
        'Select Info JSON': '情報 JSON を選択します',
        'Select Cache Directory': 'キャッシュディレクトリの選択',
        'Select Client Certificate': 'クライアント証明書の選択',
        'Select Client Certificate Key': 'クライアント証明書キーの選択',
        'Select FFmpeg Binary': 'FFmpegバイナリを選択',
        'Select Cookies File': 'Cookieファイルの選択',
        '(e.g., "ytsearch5:")': '(例: "ytsearch5:")',
        '(ISO 3166-2 code)': '(ISO 3166-2 コード)',
        '(CIDR notation)': '(CIDR表記)',
        '(e.g., "1-5,10,15-20")': '(例:「1-5、10、15-20」)',
        '(e.g., 50K or 4.2M)': '(例: 50K または 4.2M)',
        '(e.g., "%(title)s.%(ext)s")': '(例: "%(title)s.%(ext)s")',
        '(e.g., "bestvideo+bestaudio")': '(例: "bestvideo+bestaudio")',
        '(comma-separated, e.g., "en,fr,de")': '(カンマ区切り、例: "en,fr,de")',
        '(comma-separated)': '(カンマ区切り)',
        '(key:val[,val] format)': '(key:val[,val]形式)',
        '(One argument per line or space-separated)': '(引数は 1 行に 1 つ、またはスペースで区切ります)',
        '(0-10, 0 = best)': '(0 ～ 10、0 = 最高)',
        'Ignore errors (--ignore-errors)': 'エラーを無視する (--ignore-errors)',
        'Ignore warnings (--no-warnings)': '警告を無視する (--no-warnings)',
        'Abort on error (--abort-on-error)': 'エラー時に中止 (--abort-on-error)',
        'Download only video, not playlist (--no-playlist)': 'プレイリストではなくビデオのみをダウンロードします (--no-playlist)',
        'Download playlist (--yes-playlist)': 'プレイリストをダウンロードする (--yes-playlist)',
        'Include private/unavailable videos in YouTube playlists': 'YouTube プレイリストに非公開/利用不可のビデオを含める',
        'Mark videos as watched (--mark-watched)': 'ビデオを視聴済みとしてマーク (--mark-watched)',
        'Do not mark videos as watched (--no-mark-watched)': '動画を視聴済みとしてマークしません (--no-mark-watched)',
        'Force IPv4 (--force-ipv4)': 'IPv4 を強制する (--force-ipv4)',
        'Force IPv6 (--force-ipv6)': 'IPv6 を強制する (--force-ipv6)',
        'Enable file:// URLs (--enable-file-urls)': 'file:// URL を有効にする (--enable-file-urls)',
        'Bypass geo restriction (--geo-bypass)': '地理的制限をバイパスする (--geo-bypass)',
        'Do not bypass geo restriction (--no-geo-bypass)': '地理的制限をバイパスしない (--no-geo-bypass)',
        'Break on existing (--break-on-existing)': '既存のブレーク (--break-on-existing)',
        'Break on reject (--break-on-reject)': '拒否時に中断 (--break-on-reject)',
        'No break on existing (--no-break-on-existing)': '既存のブレークなし (--no-break-on-existing)',
        'Do not resize buffer (--no-resize-buffer)': 'バッファのサイズを変更しません (--no-resize-buffer)',
        'Test mode - do not download (--test)': 'テストモード - ダウンロードしません (--test)',
        'Prefer native HLS downloader (--hls-prefer-native)': 'ネイティブ HLS ダウンローダーを優先する (--hls-prefer-native)',
        'Prefer ffmpeg for HLS (--hls-prefer-ffmpeg)': 'HLS 用に ffmpeg を優先する (--hls-prefer-ffmpeg)',
        'Use MPEG-TS container for HLS (--hls-use-mpegts)': 'HLS に MPEG-TS コンテナを使用する (--hls-use-mpegts)',
        'Restrict filenames to ASCII (--restrict-filenames)': 'ファイル名を ASCII に制限する (--restrict-filenames)',
        'Allow Unicode in filenames (--no-restrict-filenames)': 'ファイル名で Unicode を許可する (--no-restrict-filenames)',
        'Create playlist subfolder for playlist downloads': 'プレイリストをダウンロードするためのプレイリスト サブフォルダーを作成する',
        'Force Windows-compatible filenames (--windows-filenames)': 'Windows と互換性のあるファイル名を強制する (--windows-filenames)',
        'Do not overwrite files (--no-overwrites)': 'ファイルを上書きしません (--no-overwrites)',
        'Force overwrite files (--force-overwrites)': 'ファイルを強制的に上書きする (--force-overwrites)',
        'Continue partially downloaded files (--continue)': '部分的にダウンロードされたファイルを続行する (--続行)',
        'Do not continue downloads (--no-continue)': 'ダウンロードを続行しません (--no-Continue)',
        'Do not use .part files (--no-part)': '.part ファイルを使用しないでください (--no-part)',
        'Do not use Last-modified header (--no-mtime)': 'Last-modified ヘッダー (--no-mtime) を使用しないでください。',
        'Write description to .description file (--write-description)': '説明を .description ファイルに書き込みます (--write-description)',
        'Write metadata to .info.json file (--write-info-json)': 'メタデータを .info.json ファイルに書き込む (--write-info-json)',
        'Write annotations to .annotations.xml (--write-annotations)': '注釈を .annotations.xml に書き込む (--write-annotations)',
        'Write comments to .comments.json (--write-comments)': '.comments.json にコメントを書き込む (--write-comments)',
        'Disable filesystem caching (--no-cache-dir)': 'ファイルシステムのキャッシュを無効にする (--no-cache-dir)',
        'Delete cache directory contents (--rm-cache-dir)': 'キャッシュ ディレクトリの内容を削除します (--rm-cache-dir)',
        'Prefer free formats (--prefer-free-formats)': 'フリーフォーマットを優先する (--prefer-free-formats)',
        'Check available formats (--check-formats)': '利用可能な形式を確認する (--check-formats)',
        'Write subtitle file (--write-subs)': '字幕ファイルの書き込み (--write-subs)',
        'Write automatic subtitle file (--write-auto-subs)': '自動字幕ファイルの書き込み (--write-auto-subs)',
        'List available subtitles (--list-subs)': '利用可能な字幕をリストする (--list-subs)',
        'Embed subtitles (--embed-subs)': '字幕を埋め込む (--embed-subs)',
        'Do not embed subtitles (--no-embed-subs)': '字幕を埋め込みません (--no-embed-subs)',
        'Embed thumbnail (--embed-thumbnail)': 'サムネイルを埋め込む (--embed-thumbnail)',
        'Do not embed thumbnail (--no-embed-thumbnail)': 'サムネイルを埋め込みません (--no-embed-thumbnail)',
        'Use .netrc authentication (--netrc)': '.netrc 認証を使用する (--netrc)',
        'Extract audio (-x, --extract-audio)': 'オーディオを抽出する (-x、--extract-audio)',
        'Keep video file after conversion (--keep-video)': '変換後にビデオファイルを保持する (--keep-video)',
        'Do not keep video file (--no-keep-video)': 'ビデオ ファイルを保持しない (--no-keep-video)',
        'Embed metadata (--embed-metadata)': 'メタデータを埋め込む (--embed-metadata)',
        'Embed chapter markers (--embed-chapters)': '章マーカーを埋め込む (--embed-chapters)',
        'Embed info.json (--embed-info-json)': 'info.json を埋め込む (--embed-info-json)',
        'Add metadata to file (--add-metadata)': 'メタデータをファイルに追加 (--add-metadata)',
        'Write all thumbnail formats (--write-all-thumbnails)': 'すべてのサムネイル形式を書き込む (--write-all-thumbnails)',
        'No warnings (--no-warnings)': '警告なし (--no-warnings)',
        'Simulate, do not download (-s, --simulate)': 'シミュレートします、ダウンロードしません (-s、--simulate)',
        'Skip download (--skip-download)': 'ダウンロードをスキップ (--skip-download)',
        'Get title (--get-title)': 'タイトルを取得 (--get-title)',
        'Get ID (--get-id)': 'ID の取得 (--get-id)',
        'Get URL (--get-url)': 'URL を取得 (--get-url)',
        'Get thumbnail URL (--get-thumbnail)': 'サムネイル URL を取得 (--get-thumbnail)',
        'Get description (--get-description)': '説明の取得 (--get-description)',
        'Get duration (--get-duration)': '期間を取得する (--get-duration)',
        'Get filename (--get-filename)': 'ファイル名を取得 (--get-filename)',
        'Get format (--get-format)': 'フォーマットの取得 (--get-format)',
        'Dump JSON info (--dump-json)': 'JSON 情報をダンプします (--dump-json)',
        'Dump single JSON (--dump-single-json)': '単一の JSON をダンプする (--dump-single-json)',
        'Print JSON info (--print-json)': 'JSON 情報を印刷する (--print-json)',
        'Show progress (--progress)': '進行状況を表示 (--progress)',
        'Hide progress (--no-progress)': '進行状況を非表示にする (--no-progress)',
        'Display progress in console title (--console-title)': 'コンソールタイトルに進行状況を表示 (--console-title)',
        'Skip SSL certificate validation (--no-check-certificate)': 'SSL 証明書の検証をスキップ (--no-check-certificate)',
        'Prefer insecure connections (--prefer-insecure)': '安全でない接続を優先する (--prefer-insecure)',
        'Bidirectional text workaround (--bidi-workaround)': '双方向テキストの回避策 (--bidi-workaround)',
        'Use legacy server connect (--legacy-server-connect)': 'レガシーサーバー接続を使用する (--legacy-server-connect)',
        'Mark SponsorBlock chapters (--sponsorblock-mark)': 'SponsorBlock の章をマークする (--sponsorblock-mark)',
        'Remove SponsorBlock segments (--sponsorblock-remove)': 'SponsorBlock セグメントを削除します (--sponsorblock-remove)',
        'Disable SponsorBlock (--no-sponsorblock)': 'スポンサーブロックを無効にする (--no-sponsorblock)',
        'Allow dynamic MPD manifests (--allow-dynamic-mpd)': '動的 MPD マニフェストを許可する (--allow-dynamic-mpd)',
        'Ignore dynamic MPD manifests (--ignore-dynamic-mpd)': '動的 MPD マニフェストを無視する (--ignore-dynamic-mpd)',
        'Split HLS segments on discontinuity (--hls-split-discontinuity)': '不連続点で HLS セグメントを分割します (--hls-split-discontinuity)',
    },
    'ko': {
    ...
    'de': {
        ...
        'SponsorBlock': 'SponsorBlock-Funktion',
        'Adobe Pass MSO:': 'Adobe Pass MSO-Konto:',
        'Remove SponsorBlock segments (--sponsorblock-remove)': 'SponsorBlock-Segmente entfernen (--sponsorblock-remove)',
        'Disable SponsorBlock (--no-sponsorblock)': 'SponsorBlock deaktivieren (--no-sponsorblock)',
        ...
        'Split HLS segments on discontinuity (--hls-split-discontinuity)': 'HLS-Segmente bei Diskontinuitaet aufteilen (--hls-split-discontinuity)',
    },
}
