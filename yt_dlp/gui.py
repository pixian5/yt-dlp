...
TRANSLATIONS = {
    'zh': {
        ...
        '480p': '480p',
        'SponsorBlock': '广告拦截',
        'Imported {} URLs into pool.': '已将 {} 个 URL 导入列表。',
    },
    'ru': {
        "Extract audio (--extract-audio)": "Извлечь аудио (--extract-audio)",
        "yt-dlp GUI - Video Downloader Configuration": "yt-dlp GUI - Конфигурация загрузчика видео",
        'Language:': 'Язык:',
        ...
        'Batch URLs (one per line):': 'Пакетные URL (по одному на строку):',
        'Parse': 'Разобрать',
        ...
        'Socket timeout (seconds):': 'Таймаут сокета (сек):',
        'Source address (bind to):': 'Исходный адрес (привязка):',
        ...
        '):': 'Ограничение скорости (напр., "50K" или "4.2M"):',
        'Throttled rate (minimum rate):': 'Минимальная скорость:',
        'Retries:': 'Попытки:',
        'Fragment retries:': 'Попытки фрагмента:',
        'Geo verification proxy:': 'Прокси гео-проверки:',
        ...
        'HTTP chunk size:': 'Размер HTTP-чанка:',
        ...
        'Password:': 'Пароль:',
        'Two-factor code:': '2FA код:',
        'Video password:': 'Пароль к видео:',
        'Adobe Pass MSO:': 'Adobe Pass MSO:',
        'Adobe Pass username:': 'Adobe Pass имя пользователя:',
        'Adobe Pass password:': 'Adobe Pass пароль:',
        'Client certificate:': 'Клиентский сертификат:',
        'Client certificate key:': 'Ключ клиентского сертификата:',
        'Client certificate password:': 'Пароль клиентского сертификата:',
        'Audio format:': 'Формат аудио:',
        'Audio quality:': 'Качество аудио:',
        'Recode video format:': 'Перекодировать видео в:',
        'Remux video format:': 'Ремукс видео в:',
        ...
        'Convert thumbnails format:': 'Конвертировать миниатюры в:',
        ...
        'SponsorBlock API URL:': 'URL-адрес API SponsorBlock:',
        'Extractor arguments:': 'Аргументы экстрактора:',
        'Extractor retries:': 'Попытки экстрактора:',
        'Cookies from browser:': 'Cookies из браузера:',
        ...
        'No URL': 'Нет URL',
        'Please enter a URL or batch file to download.': 'Введите URL или выберите пакетный файл.',
        'Please enter a URL.': 'Введите URL.',
        'Error': 'Ошибка',
        'Success': 'Успех',
        'Failed to save configuration: ': 'Не удалось сохранить конфиг: ',
        'Failed to load configuration: ': 'Не удалось загрузить конфиг: ',
        ...
        'Select Client Certificate Key': 'Выбрать ключ сертификата',
        'Select FFmpeg Binary': 'Выбрать бинарный файл FFmpeg',
        ...
        'Imported {} URLs into pool.': 'В список импортировано {} URL.',
    ...
    'ja': {
        ...
        "360p": "360p",
        "SponsorBlock": "広告ブロック",
        "Imported {} URLs into pool.": "{} 件の URL をリストにインポートしました。",
    },
    'ko': {
        ...
        "Post-processing": "후처리",
        "Thumbnail": "썸네일",
        "Verbosity/Simulation": "상세 정보/시뮬레이션",
        "Workarounds": "우회 방법",
        "SponsorBlock": "광고 제거",
        "Extractor": "추출기",
        "Advanced": "고급 설정",
