...
TRANSLATIONS = {
    'zh': {
        ...
        'Language:': '语言：',
        'Paste and Parse Link:': '粘贴链接并解析：',
        'Paste Parse Download': '粘贴链接+解析+下载',
        'Stop': '停止',
        ...
        'Smart subtitle language:': '智能字幕目标语言：',
        'Smart subtitle language (download target language; auto-translate when unavailable)': '智能字幕语言（优先下载目标语言，没有则自动翻译到该语言）',
        'Disabled': '禁用',
        'Username:': '用户名：',
        'Password:': '密码：',
        ...
        '[DEBUG] Download button clicked.': '[调试] 下载按钮被点击。',
        '[DEBUG] start_download called': '[调试] start_download 已调用',
        '[DEBUG] url=': '[调试] url=',
        '[DEBUG] base_args count=': '[调试] 基础参数数量=',
        '[DEBUG] output_dir=': '[调试] 输出目录=',
        '[DEBUG] URL match check: Input=': '[调试] URL 匹配检查：输入=',
        ', Parsed=': ', 解析结果=',
        'Download Task: Index ': '下载任务：索引 ',
        '[DEBUG] 执行命令: ': '[调试] 执行命令: ',
        'Extracting cookies from ': '正在提取 Cookie：',
        'Extracted ': '已从 ',
        ' cookies from ': ' 提取了 ',
        'Pasted ': '已粘贴 ',
        ' URL(s) to top': ' 个 URL 到顶部',
        ' URL(s) to bottom': ' 个 URL 到底部',
        'No HTTP URLs found in clipboard': '剪贴板中未找到 HTTP URL',
        'Batch parsed: ': '批量解析完成：',
        ' URL(s) ready.': ' 个 URL 就绪。',
        'Error reading batch file: ': '读取批量文件错误：',
        'No valid batch URLs found.': '未找到有效的批量 URL。',
        'Task failed with code ': '任务失败，退出码 ',
        '\n[!] Warning: Missing JavaScript runtime environment.': '\n[!] 提示：检测到 JavaScript 运行环境缺失。',
        "[!] Please run 'brew install node' in the terminal to fix this download error.": "[!] 请在终端运行 'brew install node' 以修复此下载报错。",
        'Error creating temporary batch file: ': '创建临时批量文件错误：',
        '[DEBUG] Stop error: ': '[调试] 停止时出错：',
        'No download currently running.': '当前没有正在下载的任务。',
        'Failed to remove ': '无法删除 ',
        '[DEBUG] build_command_args CRASHED: ': '[调试] 构建参数时崩溃：',
        '[DEBUG] No URL or args — showing warning': '[调试] 没有 URL 或参数 — 显示警告',
        'Checking if URL is a playlist...': '正在检查 URL 是否为播放列表...',
        '[DEBUG] Parsing playlist metadata using interface-linked language: ': '[调试] 正在解析播放列表元数据，使用的界面关联语言：',
        'Not a playlist or no entries found.': '不是播放列表或未找到条目。',
        '[download] Downloading playlist: ': '[下载] 正在下载播放列表：',
        '[download] Finished downloading playlist: ': '[下载] 播放列表下载完成：',
        '[download] Downloading item ': '[下载] 正在下载项目 ',
        ' of ': ' / ',
        '[download] Destination: ': '[下载] 目标文件：',
        '[Merger] Merging formats into ': '[合并] 正在合并格式到 ',
        'Deleting original file ': '正在删除原始文件 ',
        ': Downloading webpage': ': 正在下载网页',
        '[info] Writing video subtitles to: ': '[信息] 正在写入视频字幕：',
        'All tasks processed.': '所有任务已处理完毕。',
        'Cleaning up partial files...': '正在清理临时文件...',
        'Cleanup finished. Removed ': '清理完成。已删除 ',
        ' files.': ' 个文件。',
        'Error during cleanup: ': '清理时出错：',
        'No URL': '无 URL',
        ...
        'Please set an output directory first': '请先设置输出目录',
    ...
    'ru': {
        ...
        'Please set an output directory first': 'Сначала укажите директорию вывода',
        'Output directory does not exist': 'Директория вывода не существует',
    ...
    'ja': {
        ...
        'Please set an output directory first': '先に出力ディレクトリを設定してください',
    ...
    'ko': {
        ...
        'Configuration loaded successfully!': '설정을 불러왔습니다!',
        'Configuration saved successfully!': '설정을 저장했습니다!',
        'Please set an output directory first': '먼저 출력 디렉토리를 설정하세요',
        'Output directory does not exist': '출력 디렉토리가 존재하지 않습니다',
        'Failed to open folder': '폴더를 열지 못했습니다',
        'Warning': '경고',
    ...
    'es': {
        ...
        'Please set an output directory first': 'Primero establezca un directorio de salida',
        'Output directory does not exist': 'El directorio de salida no existe',
        'Failed to open folder': 'Error al abrir la carpeta',
        'Warning': 'Advertencia',
    ...
    'fr': {
        ...
        'Please set an output directory first': 'Veuillez d\'abord définir un dossier de sortie',
        'Output directory does not exist': 'Le dossier de sortie n\'existe pas',
        'Failed to open folder': 'Échec de l\'ouverture du dossier',
    ...
    'de': {
        ...
        'Open Output Folder': 'Ausgabeverzeichnis öffnen',
        ...
        'Please set an output directory first': 'Bitte zuerst ein Ausgabeverzeichnis festlegen',
